...
/**
 * Home page with search, filters, and pagination
 * Optimized for performance with useMemo and useCallback
 */
const Home = () => {
  ...
  // Fetch products on mount and when query params change
  useEffect(() => {
    fetchProducts();
  }, [fetchProducts]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to HPC Ultra</h1>
          <p className="text-xl text-primary-100">Discover premium products for your everyday needs</p>
        </div>
      </div>
